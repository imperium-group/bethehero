...
<h1 align="center">
  <img alt="Layout" src="./github/main-image/logo/be_the_hero.png">
</h1>
<br/>
<h1 align="center">
  <img alt="Layout" src="./github/main-image/gif/bethehero-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the Live_the_Hero project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for BeTheHero project
</h3>
...
<p align="center">BeTheHero - Science fiction characters information app!</p>

This api is manage BeTheHero app, developed with Typescript, NodeJs, Express, TypeORM, Postgres e JWT.
...
```bash
$ git clone https://github.com/vynnydev/bethehero.git && cd bethehero
...
$ gh repo fork vynnydev/bethehero
```
...
```bash
# Clone your fork
$ git clone your-fork-url && cd bethehero
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for BeTheHero project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/bethehero-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/bethehero-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/bethehero-reset-password.png">
</p>
...
<h3 align="center">
  React Native Application for BeTheHero project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/bethehero-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/Vynny21/live_the_hero_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/Vynny21/bethehero_mob.git && cd bethehero_mob
OR 
$ git clone https://github.com/Vynny21/bethehero_mob.git
...
$ gh repo fork vynnydev/bethehero_mob
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd bethehero_mob
